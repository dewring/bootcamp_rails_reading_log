...
# docker build -t bootcamp_rails_reading_log .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name bootcamp_rails_reading_log bootcamp_rails_reading_log
